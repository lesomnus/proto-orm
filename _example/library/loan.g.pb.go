...
func (x *LoanAddRequest) GetBook() *BookGetRequest {
	if x != nil {
		return x.Book
	}
	return nil
...
func (x *LoanAddRequest) GetMember() *MemberGetRequest {
	if x != nil {
		return x.Member
	}
	return nil
...
var file_example_library_loan_g_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfa, 0x02, 0x0a, 0x0e, 0x4c, 0x6f,
...
var file_example_library_loan_g_proto_depIdxs = []int32{
	3,  // 0: example.library.LoanAddRequest.book:type_name -> example.library.BookGetRequest
	4,  // 1: example.library.LoanAddRequest.member:type_name -> example.library.MemberGetRequest
