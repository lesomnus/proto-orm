...
type BookSelect struct {
	...
	xxx_hidden_Title       bool                   `protobuf:"varint,3,opt,name=title,proto3,oneof" json:"title,omitempty"`
	xxx_hidden_Authors     *AuthorSelect          `protobuf:"bytes,4,opt,name=authors,proto3,oneof" json:"authors,omitempty"`
	xxx_hidden_Index       bool                   `protobuf:"varint,5,opt,name=index,proto3,oneof" json:"index,omitempty"`
	xxx_hidden_Genres      bool                   `protobuf:"varint,6,opt,name=genres,proto3,oneof" json:"genres,omitempty"`
...
type BookPatchRequest struct {
	...
	xxx_hidden_Authors     *[]*BookPatchAuthors   `protobuf:"bytes,7,rep,name=authors,proto3" json:"authors,omitempty"`
...
func (x *BookPatchRequest) GetAuthors() []*BookPatchAuthors {
	if x != nil {
...
func (x *BookPatchRequest) SetAuthors(v []*BookPatchAuthors) {
	x.xxx_hidden_Authors = &v
}
...
type BookPatchAuthors struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Op    proto_orm.PatchOp      `protobuf:"varint,1,opt,name=op,proto3,enum=orm.PatchOp" json:"op,omitempty"`
	xxx_hidden_Items *[]*AuthorGetRequest   `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *BookPatchAuthors) Reset() {
	*x = BookPatchAuthors{}
	mi := &file_example_library_book_svc_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BookPatchAuthors) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BookPatchAuthors) ProtoMessage() {}

func (x *BookPatchAuthors) ProtoReflect() protoreflect.Message {
	mi := &file_example_library_book_svc_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *BookPatchAuthors) GetOp() proto_orm.PatchOp {
	if x != nil {
...
func (x *BookPatchAuthors) GetItems() []*AuthorGetRequest {
	if x != nil {
...
func (x *BookPatchAuthors) SetOp(v proto_orm.PatchOp) {
	x.xxx_hidden_Op = v
}

func (x *BookPatchAuthors) SetItems(v []*AuthorGetRequest) {
	x.xxx_hidden_Items = &v
}

type BookPatchAuthors_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	Op    proto_orm.PatchOp
	Items []*AuthorGetRequest
}

func (b0 BookPatchAuthors_builder) Build() *BookPatchAuthors {
	m0 := &BookPatchAuthors{}
	b, x := &b0, m0
	_, _ = b, x
...
var file_example_library_book_svc_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72,
	0x79, 0x2f, 0x62, 0x6f, 0x6f, 0x6b, 0x5f, 0x73, 0x76, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x72, 0x79, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x5f, 0x73, 0x76, 0x63, 0x2e, 0x70, 0x72,
	...
	0x72, 0x6d, 0x2f, 0x70, 0x61, 0x74, 0x63, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe2,
	...
	,
	...
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x88, 0x01, 0x01, 0x12, 0x3b, 0x0a, 0x07, 0x61, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x65, 0x78, 0x61,
	0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x2e, 0x42, 0x6f, 0x6f,
	0x6b, 0x50, 0x61, 0x74, 0x63, 0x68, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x52, 0x07, 0x61,
	...
	0x73, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x69, 0x0a, 0x10, 0x42,
	0x6f, 0x6f, 0x6b, 0x50, 0x61, 0x74, 0x63, 0x68, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x12,
	0x1c, 0x0a, 0x02, 0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x6f, 0x72,
	0x6d, 0x2e, 0x50, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x52, 0x02, 0x6f, 0x70, 0x12, 0x37, 0x0a,
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x65,
	...
	,
...
var file_example_library_book_svc_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_example_library_book_svc_proto_goTypes = []any{
	...
	(*BookPatchAuthors)(nil),      // 4: example.library.BookPatchAuthors
	(*Book_Index)(nil),            // 5: example.library.Book.Index
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
	(*AuthorSelect)(nil),          // 7: example.library.AuthorSelect
	(proto_orm.PatchOp)(0),        // 8: orm.PatchOp
	(*AuthorGetRequest)(nil),      // 9: example.library.AuthorGetRequest
	(*Book)(nil),                  // 10: example.library.Book
	(*emptypb.Empty)(nil),         // 11: google.protobuf.Empty
}
var file_example_library_book_svc_proto_depIdxs = []int32{
	5,  // 0: example.library.BookAddRequest.index:type_name -> example.library.Book.Index
	6,  // 1: example.library.BookAddRequest.date_created:type_name -> google.protobuf.Timestamp
	2,  // 2: example.library.BookGetRequest.select:type_name -> example.library.BookSelect
	7,  // 3: example.library.BookSelect.authors:type_name -> example.library.AuthorSelect
	1,  // 4: example.library.BookPatchRequest.key:type_name -> example.library.BookGetRequest
	4,  // 5: example.library.BookPatchRequest.authors:type_name -> example.library.BookPatchAuthors
	5,  // 6: example.library.BookPatchRequest.index:type_name -> example.library.Book.Index
	8,  // 7: example.library.BookPatchAuthors.op:type_name -> orm.PatchOp
	9,  // 8: example.library.BookPatchAuthors.items:type_name -> example.library.AuthorGetRequest
	0,  // 9: example.library.BookService.Add:input_type -> example.library.BookAddRequest
	1,  // 10: example.library.BookService.Get:input_type -> example.library.BookGetRequest
	3,  // 11: example.library.BookService.Patch:input_type -> example.library.BookPatchRequest
	1,  // 12: example.library.BookService.Erase:input_type -> example.library.BookGetRequest
	10, // 13: example.library.BookService.Add:output_type -> example.library.Book
	10, // 14: example.library.BookService.Get:output_type -> example.library.Book
	11, // 15: example.library.BookService.Patch:output_type -> google.protobuf.Empty
	11, // 16: example.library.BookService.Erase:output_type -> google.protobuf.Empty
...
func file_example_library_book_svc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_library_book_svc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_example_library_book_svc_proto_rawDesc = nil
