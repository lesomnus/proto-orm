...
type FooK struct {
	...
	xxx_hidden_KVdTime  *timestamppb.Timestamp            `protobuf:"bytes,12,opt,name=k_vd_time,json=kVdTime,proto3" json:"k_vd_time,omitempty"`
...
type FooEf struct {
	...
	xxx_hidden_EfVdAuthor  *Author                `protobuf:"bytes,12,opt,name=ef_vd_author,json=efVdAuthor,proto3" json:"ef_vd_author,omitempty"`
...
var file_example_library_foo_proto_rawDesc = []byte{
...
func file_example_library_foo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_library_foo_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   34,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_example_library_foo_proto_rawDesc = nil
