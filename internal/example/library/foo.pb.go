...
const file_example_library_foo_proto_rawDesc = "" +
	"\n" +
	"\x19example/library/foo.proto\x12\x0fexample.library\x1a\x1cexample/library/author.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\"\xb8\x01\n" +
	"\x04FooV\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12\x19\n" +
	...
	"\av_bytes\x18\x10 \x01(\fR\x06vBytes\"\xf5\x01\n" +
	"\x05FooVd\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12#\n" +
	"\tvd_double\x18\v \x01(\x01B\x06\xda\xfc\x15\x02J\x00R\bvdDouble\x12!\n" +
	"\bvd_int64\x18\f \x01(\x03B\x06\xda\xfc\x15\x02J\x00R\avdInt64\x12#\n" +
	"\tvd_uint64\x18\r \x01(\x04B\x06\xda\xfc\x15\x02J\x00R\bvdUint64\x12\x1f\n" +
	"\avd_bool\x18\x0e \x01(\bB\x06\xda\xfc\x15\x02J\x00R\x06vdBool\x12#\n" +
	"\tvd_string\x18\x0f \x01(\tB\x06\xda\xfc\x15\x02J\x00R\bvdString\x12!\n" +
	"\bvd_bytes\x18\x10 \x01(\fB\x06\xda\xfc\x15\x02J\x00R\avdBytes\"\xc5\x01\n" +
	"\x05FooVr\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12\x1b\n" +
	...
	"\bvr_bytes\x18\x10 \x03(\fR\avrBytes\"\xb3\x02\n" +
	"\x05FooVo\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12 \n" +
	...
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12*\n" +
	"\n" +
	"von_double\x18\v \x01(\x01B\x06\xda\xfc\x15\x028\x01H\x00R\tvonDouble\x88\x01\x01\x12(\n" +
	"\tvon_int64\x18\f \x01(\x03B\x06\xda\xfc\x15\x028\x01H\x01R\bvonInt64\x88\x01\x01\x12*\n" +
	"\n" +
	"von_uint64\x18\r \x01(\x04B\x06\xda\xfc\x15\x028\x01H\x02R\tvonUint64\x88\x01\x01\x12&\n" +
	"\bvon_bool\x18\x0e \x01(\bB\x06\xda\xfc\x15\x028\x01H\x03R\avonBool\x88\x01\x01\x12*\n" +
	"\n" +
	"von_string\x18\x0f \x01(\tB\x06\xda\xfc\x15\x028\x01H\x04R\tvonString\x88\x01\x01\x12(\n" +
	"\tvon_bytes\x18\x10 \x01(\fB\x06\xda\xfc\x15\x028\x01H\x05R\bvonBytes\x88\x01\x01B\r\n" +
	"\v_von_doubleB\f\n" +
	"\n" +
	"_von_int64B\r\n" +
	"\v_von_uint64B\v\n" +
	...
	"_von_bytes\"\xa7\x06\n" +
	"\x05FooMi\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12D\n" +
	"\n" +
	"vmi_double\x18\v \x03(\v2%.example.library.FooMi.VmiDoubleEntryR\tvmiDouble\x12A\n" +
	"\tvmi_int64\x18\f \x03(\v2$.example.library.FooMi.VmiInt64EntryR\bvmiInt64\x12D\n" +
	"\n" +
	"vmi_uint64\x18\r \x03(\v2%.example.library.FooMi.VmiUint64EntryR\tvmiUint64\x12>\n" +
	"\bvmi_bool\x18\x0e \x03(\v2#.example.library.FooMi.VmiBoolEntryR\avmiBool\x12D\n" +
	"\n" +
	"vmi_string\x18\x0f \x03(\v2%.example.library.FooMi.VmiStringEntryR\tvmiString\x12A\n" +
	"\tvmi_bytes\x18\x10 \x03(\v2$.example.library.FooMi.VmiBytesEntryR\bvmiBytes\x1a<\n" +
	...
	"\x03key\x18\x01 \x01(\x03R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\xa7\x06\n" +
	"\x05FooMs\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12D\n" +
	"\n" +
	"vms_double\x18\v \x03(\v2%.example.library.FooMs.VmsDoubleEntryR\tvmsDouble\x12A\n" +
	"\tvms_int64\x18\f \x03(\v2$.example.library.FooMs.VmsInt64EntryR\bvmsInt64\x12D\n" +
	"\n" +
	"vms_uint64\x18\r \x03(\v2%.example.library.FooMs.VmsUint64EntryR\tvmsUint64\x12>\n" +
	"\bvms_bool\x18\x0e \x03(\v2#.example.library.FooMs.VmsBoolEntryR\avmsBool\x12D\n" +
	"\n" +
	"vms_string\x18\x0f \x03(\v2%.example.library.FooMs.VmsStringEntryR\tvmsString\x12A\n" +
	"\tvms_bytes\x18\x10 \x03(\v2$.example.library.FooMs.VmsBytesEntryR\bvmsBytes\x1a<\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\xde\x06\n" +
	"\x06FooMsd\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x12M\n" +
	"\n" +
	"msd_double\x18\v \x03(\v2&.example.library.FooMsd.MsdDoubleEntryB\x06\xda\xfc\x15\x02J\x00R\tmsdDouble\x12J\n" +
	"\tmsd_int64\x18\f \x03(\v2%.example.library.FooMsd.MsdInt64EntryB\x06\xda\xfc\x15\x02J\x00R\bmsdInt64\x12M\n" +
	"\n" +
	"msd_uint64\x18\r \x03(\v2&.example.library.FooMsd.MsdUint64EntryB\x06\xda\xfc\x15\x02J\x00R\tmsdUint64\x12G\n" +
	"\bmsd_bool\x18\x0e \x03(\v2$.example.library.FooMsd.MsdBoolEntryB\x06\xda\xfc\x15\x02J\x00R\amsdBool\x12M\n" +
	"\n" +
	"msd_string\x18\x0f \x03(\v2&.example.library.FooMsd.MsdStringEntryB\x06\xda\xfc\x15\x02J\x00R\tmsdString\x12J\n" +
	"\tmsd_bytes\x18\x10 \x03(\v2%.example.library.FooMsd.MsdBytesEntryB\x06\xda\xfc\x15\x02J\x00R\bmsdBytes\x1a<\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01\"\xeb\x05\n" +
	"\x04FooK\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x124\n" +
	"\bk_v_time\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\x06kVTime\x12>\n" +
	"\tk_vd_time\x18\f \x01(\v2\x1a.google.protobuf.TimestampB\x06\xda\xfc\x15\x02J\x00R\akVdTime\x126\n" +
	"\tk_vr_time\x18\r \x03(\v2\x1a.google.protobuf.TimestampR\akVrTime\x12;\n" +
	"\tk_vo_time\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampH\x00R\akVoTime\x88\x01\x01\x12>\n" +
	"\tk_mi_time\x18\x0f \x03(\v2\".example.library.FooK.KMiTimeEntryR\akMiTime\x12>\n" +
	"\tk_ms_time\x18\x10 \x03(\v2\".example.library.FooK.KMsTimeEntryR\akMsTime\x12I\n" +
	"\n" +
	"k_msd_time\x18\x11 \x03(\v2#.example.library.FooK.KMsdTimeEntryB\x06\xda\xfc\x15\x02J\x00R\bkMsdTime\x1aV\n" +
	...
	"_k_vo_time\"\x99\x06\n" +
	"\x05FooEf\x12\x16\n" +
	"\x02id\x18\x01 \x01(\x03B\x06\xda\xfc\x15\x02(\x01R\x02id\x127\n" +
	"\vef_v_author\x18\v \x01(\v2\x17.example.library.AuthorR\tefVAuthor\x12A\n" +
	"\fef_vd_author\x18\f \x01(\v2\x17.example.library.AuthorB\x06\xda\xfc\x15\x02J\x00R\n" +
	"efVdAuthor\x129\n" +
	"\fef_vr_author\x18\r \x03(\v2\x17.example.library.AuthorR\n" +
	"efVrAuthor\x12>\n" +
	"\fef_vo_author\x18\x0e \x01(\v2\x17.example.library.AuthorH\x00R\n" +
	"efVoAuthor\x88\x01\x01\x12H\n" +
	"\fef_mi_author\x18\x0f \x03(\v2&.example.library.FooEf.EfMiAuthorEntryR\n" +
	"efMiAuthor\x12H\n" +
	"\fef_ms_author\x18\x10 \x03(\v2&.example.library.FooEf.EfMsAuthorEntryR\n" +
	"efMsAuthor\x12S\n" +
	"\ref_msd_author\x18\x11 \x03(\v2'.example.library.FooEf.EfMsdAuthorEntryB\x06\xda\xfc\x15\x02J\x00R\vefMsdAuthor\x1aV\n" +
	...
	"\r_ef_vo_authorBB\xc2\xfc\x15\x06\n" +
