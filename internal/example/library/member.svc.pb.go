...
type LockerGetRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Select *LockerSelect          `protobuf:"bytes,1,opt,name=select,proto3" json:"select,omitempty"`
...
type LockerSelect struct {
	...
	xxx_hidden_Owner  *MemberSelect          `protobuf:"bytes,2,opt,name=owner,proto3,oneof" json:"owner,omitempty"`
	xxx_hidden_Name   bool                   `protobuf:"varint,3,opt,name=name,proto3" json:"name,omitempty"`
	xxx_hidden_Number bool                   `protobuf:"varint,4,opt,name=number,proto3" json:"number,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type LockerPatchRequest struct {
	...
	xxx_hidden_Number      uint32                 `protobuf:"varint,7,opt,name=number,proto3,oneof" json:"number,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type MemberGetRequest struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Select *MemberSelect          `protobuf:"bytes,1,opt,name=select,proto3" json:"select,omitempty"`
...
type MemberSelect struct {
	...
	xxx_hidden_All         bool                   `protobuf:"varint,1,opt,name=all,proto3" json:"all,omitempty"`
	xxx_hidden_Name        bool                   `protobuf:"varint,3,opt,name=name,proto3" json:"name,omitempty"`
	xxx_hidden_Labels      bool                   `protobuf:"varint,4,opt,name=labels,proto3" json:"labels,omitempty"`
	xxx_hidden_Profile     bool                   `protobuf:"varint,5,opt,name=profile,proto3" json:"profile,omitempty"`
	xxx_hidden_Level       bool                   `protobuf:"varint,6,opt,name=level,proto3" json:"level,omitempty"`
	xxx_hidden_Locker      *LockerSelect          `protobuf:"bytes,7,opt,name=locker,proto3,oneof" json:"locker,omitempty"`
	xxx_hidden_Parent      *MemberSelect          `protobuf:"bytes,8,opt,name=parent,proto3,oneof" json:"parent,omitempty"`
	xxx_hidden_Children    *MemberSelect          `protobuf:"bytes,9,opt,name=children,proto3,oneof" json:"children,omitempty"`
...
type MemberPatchRequest struct {
	...
	xxx_hidden_ParentNull  bool                   `protobuf:"varint,16,opt,name=parent_null,json=parentNull,proto3" json:"parent_null,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
var file_example_library_member_svc_proto_rawDesc = []byte{
...
func file_example_library_member_svc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_library_member_svc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   2,
	...
	file_example_library_member_svc_proto_rawDesc = nil
