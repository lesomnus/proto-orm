...
type Author struct {
	...
	xxx_hidden_Books       *[]*Book               `protobuf:"bytes,7,rep,name=books,proto3" json:"books,omitempty"`
...
type Book struct {
	...
	xxx_hidden_Authors     *[]*Author             `protobuf:"bytes,4,rep,name=authors,proto3" json:"authors,omitempty"`
...
type Book_Index struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Chapter int32                  `protobuf:"varint,1,opt,name=chapter,proto3" json:"chapter,omitempty"`
	xxx_hidden_Title   string                 `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	xxx_hidden_Range   *Book_Index_Range      `protobuf:"bytes,3,opt,name=range,proto3" json:"range,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type Book_Index_Range struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Begin int32                  `protobuf:"varint,1,opt,name=begin,proto3" json:"begin,omitempty"`
	xxx_hidden_End   int32                  `protobuf:"varint,2,opt,name=end,proto3" json:"end,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
var file_example_library_author_proto_rawDesc = []byte{
	...
	0x09, 0x6f, 0x72, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x90, 0x03, 0x0a, 0x06, 0x41,
	...
	0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x42, 0x42, 0xc2,
