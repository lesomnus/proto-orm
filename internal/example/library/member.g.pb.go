...
type LockerAddRequest struct {
	...
	Owner *MemberGetRequest `protobuf:"bytes,2,opt,name=owner,proto3" json:"owner,omitempty"`
}
...
type LockerPatchRequest struct {
	...
	Owner     *MemberGetRequest `protobuf:"bytes,3,opt,name=owner,proto3" json:"owner,omitempty"`
...
type MemberAddRequest struct {
	...
	Locker      *LockerGetRequest      `protobuf:"bytes,7,opt,name=locker,proto3" json:"locker,omitempty"`
...
type MemberPatchRequest struct {
	...
	Locker     *LockerGetRequest `protobuf:"bytes,13,opt,name=locker,proto3" json:"locker,omitempty"`
