...
type LoanSelect struct {
	...
	xxx_hidden_BorrowerId  bool                   `protobuf:"varint,4,opt,name=borrower_id,json=borrowerId,proto3" json:"borrower_id,omitempty"`
	xxx_hidden_Borrower    *MemberSelect          `protobuf:"bytes,5,opt,name=borrower,proto3,oneof" json:"borrower,omitempty"`
	xxx_hidden_DateDue     bool                   `protobuf:"varint,13,opt,name=date_due,json=dateDue,proto3" json:"date_due,omitempty"`
	xxx_hidden_DateReturn  bool                   `protobuf:"varint,14,opt,name=date_return,json=dateReturn,proto3" json:"date_return,omitempty"`
