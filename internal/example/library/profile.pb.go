...
type Profile struct {
	...
	xxx_hidden_Email     string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	xxx_hidden_DateBirth *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=date_birth,json=dateBirth,proto3" json:"date_birth,omitempty"`
